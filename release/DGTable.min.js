...
a=a.fromElement||a.relatedTarget;a==this||jQuery.contains(this,a)||this.__previewEl&&(a==this.__previewEl||jQuery.contains(this.__previewEl,a))||g.Za.call(g,this)}a=a||{};a.columns=a.columns||[];this.Da=_.bind(this.cb,this);this.ia=_.bind(this.bb,this);this.Fa=_.bind(this.eb,this);this.$el.on("dragend",this.ia);this.m=!0;this.S=!1;this.h=void 0===a.virtualTable?!0:!!a.virtualTable;this.r=a.rowsBufferSize||10;this.l=Math.max(a.minColumnWidth||35,0);this.T=a.resizeAreaWidth||8;this.M=void 0===a.resizableColumns?
!0:!!a.resizableColumns;this.C=void 0===a.movableColumns?!0:!!a.movableColumns;this.s=void 0===a.sortableColumns?1:parseInt(a.sortableColumns,10)||1;this.da=void 0===a.adjustColumnWidthForSortArrow?!0:!!a.adjustColumnWidthForSortArrow;this.ta=void 0===a.convertColumnWidthsToRelative?!1:!!a.convertColumnWidthsToRelative;this.Xa=void 0===a.cellClasses?"":a.cellClasses;this.kb=void 0===a.resizerClassName?"dgtable-resize":a.resizerClassName;this.ja=void 0===a.tableClassName?"dgtable":a.tableClassName;
...
b,d){this.R&&(a.mb=this.R(b,d))},this));this.f=null;this.A=a.height;this.B=0;var g=this;"addEventListener"in window?(this.I=function(a){a.__hoverIn||a.addEventListener("mouseover",a.__hoverIn=_.bind(d,a));return this},this.W=function(a){a.__hoverIn&&(a.removeEventListener("mouseover",a.__hoverIn),a.__hoverIn=null);return this},this.ha=function(a){a.__hoverOut||a.addEventListener("mouseout",a.__hoverOut=_.bind(b,a.__cell||a));return this},this.la=function(a){a.__hoverOut&&(a.removeEventListener("mouseout",
a.__hoverOut),a.__hoverOut=null);return this}):(this.I=function(a){a.__hoverIn||a.attachEvent("mouseover",a.__hoverIn=_.bind(d,a));return this},this.W=function(a){a.__hoverIn&&(a.detachEvent("mouseover",a.__hoverIn),a.__hoverIn=null);return this},this.ha=function(a){a.__hoverOut||a.attachEvent("mouseout",a.__hoverOut=_.bind(b,a.__cell||a));return this},this.la=function(a){a.__hoverOut&&(a.detachEvent("mouseout",a.__hoverOut),a.__hoverOut=null);return this})},Ha:function(a){var b=parseFloat(a),d=s.AUTO;
...
this.b.Qa()+1;for(var d=this.b.Qa(),f=h.order,c;d>=f;d--)(c=this.b.ba(d))&&c.order++;this.b.push(h);this.b.pa();this.m=!0;this.d=this.b.P();this.render();this.trigger("addColumn",h.name)}return this},removeColumn:function(a){var b=this.b.indexOf(a);-1<b&&(this.b.splice(b,1),this.b.pa(),this.m=!0,this.d=this.b.P(),this.render(),this.trigger("removeColumn",a));return this},filter:function(a,b,d){if(this.b.get(a)){var h=!!this.f;this.f&&(this.f=null);this.f=this.e.Pa(a,b,d);if(h||this.f)this.m=!0,this.render(),
this.trigger("filter",a,b,d)}return this},L:function(){this.f&&(this.f=null,this.f=this.e.Pa(this.e.O,this.e.aa,this.e.oa));return this},setColumnLabel:function(a,b){var d=this.b.get(a);if(d&&(d.label=void 0===b?d.name:b,d.element))for(var h=0;h<d.element[0].firstChild.childNodes.length;h++){var f=d.element[0].firstChild.childNodes[h];if(3===f.nodeType){f.textContent=d.label;break}}return this},moveColumn:function(a,b){var d,h;"string"===typeof a?d=this.b.get(a):"number"===typeof a&&(d=this.d[a]);
...
b=b.width();a.remove();return b}var b=null;return function(d,h){var f=this.ra(),c=f,r=0;if(c!=b||d){b=f;var e,f=0,g=[],k,m,n=0;for(k=0;k<this.b.length;k++)this.b[k].u=null;for(k=0;k<this.d.length;k++)m=this.d[k],m.n==s.ABSOLUTE?(e=m.width,e+=m.na||0,e<this.l&&(e=this.l),c-=e,f+=e,e!==m.j&&(m.j=e,g.push(k))):m.n==s.AUTO?(e=_.bind(a,this)(m.label)+20,e+=m.na||0,e<this.l&&(e=this.l),c-=e,f+=e,e!==m.j&&(m.j=e,this.ta||g.push(k))):m.n==s.RELATIVE&&(n+=m.width,r++);if(this.ta)for(k=0;k<this.d.length;k++)m=
this.d[k],m.n===s.AUTO&&(m.n=s.RELATIVE,c+=m.j,m.width=m.j/f,n+=m.width,r++);if(r&&(1>n&&this.gb||1<n&&this.hb))for(k=0;k<this.d.length;k++)m=this.d[k],m.n===s.RELATIVE&&(m.width/=n);f=c;for(k=0;k<this.d.length;k++)m=this.d[k],m.n===s.RELATIVE&&(e=Math.round(f*m.width),e<this.l&&(e=this.l),c-=e,r--,0===r&&1===c&&(e++,c--),-1===c&&(e--,c++),e!==m.j&&(m.j=e,g.push(k)));this.d[this.d.length-1].u=this.d[this.d.length-1].j-(this.U||0);if(h||void 0===h)for(k=0;k<g.length;k++)this.jb(g[k])}return this}}(),
...
left:f.left,top:f.top,height:b})[0].k=d[0].k;try{this.i[0].style.zIndex=""}catch(r){}c(document).on("mousemove",this.Da);c(document).on("mouseup",this.ia);a.preventDefault()}else this.C?(b=c(a.target).closest("th,div."+this.q),(d=this.b.get(b[0].k))&&d.F?(b[0].style.opacity=0.35,this.fa=161061273*Math.random(),a.originalEvent.dataTransfer.setData("text",JSON.stringify({Oa:this.fa,column:d.name}))):a.preventDefault()):a.preventDefault()},cb:function(a){var b=this.b.get(this.i[0].k),d=this.K(),b=b.element,
...
c(document).off("mouseup",this.ia);var b=this.b.get(this.i[0].k),d=this.K(),h=b.element,f=this.i.parent(),e=h.offset(),g=f.offset();g.left+=parseFloat(f.css("border-left-width"))||0;e.left-=g.left;f=this.i.outerWidth();a=a.pageX-g.left;e=g=e.left;e=0;d?(a+=this.J(h[0]),g+=h.outerWidth(),g-=Math.ceil((parseFloat(h.css("border-right-width"))||0)/2),g-=Math.ceil(f/2),e=g-this.l,a>e&&(a=e),e=g-a):(a-=this.J(h[0]),g+=Math.ceil((parseFloat(h.css("border-right-width"))||0)/2),g-=Math.ceil(f/2),e=g+this.l,
a<e&&(a=e),e=a-g);this.i.remove();this.i=null;d=e;if(b.n===s.RELATIVE){d=this.ra();for(h=0;h<this.d.length;h++)f=this.d[h],f.n!=s.RELATIVE&&(d-=f.j);d=e/d*100;d+="%"}this.setColumnWidth(b.name,d)}else a.target.style.opacity=null},xa:function(a){if(this.C){var b=a.originalEvent.dataTransfer.getData("text"),b=b?JSON.parse(b):null;a=c(a.target).closest("th,div."+this.q);(!b||this.fa==b.Oa&&a.k!==b.column)&&(b=this.b.get(a[0].k))&&(b.F||b!=this.d[0])&&c(a).addClass("drag-over")}},za:function(a){a.preventDefault()},
ya:function(a){var b=c(a.target).closest("th,div."+this.q);c(b[0].firstChild).has(a.originalEvent.relatedTarget).length||b.removeClass("drag-over")},Aa:function(a){a.preventDefault();var b=JSON.parse(a.originalEvent.dataTransfer.getData("text"));a=c(a.target).closest("th,div."+this.q);if(this.C&&b.Oa==this.fa){var b=b.column,d=a[0].k,h=this.b.get(b),f=this.b.get(d);h&&f&&h.F&&(f.F||f!=this.d[0])&&this.moveColumn(b,d)}c(a).removeClass("drag-over")},sa:function(){if(this.g){var a=this.g.find(">thead>tr>th.sorted"),
b=a.find(">div>.sort-arrow");_.forEach(b,_.bind(function(a){if(a=this.b.get(a.parentNode.parentNode.k))a.na=0},this));b.remove();a.removeClass("sorted").removeClass("desc")}return this},Ka:function(a,b){var d=this.b.get(a),h=t("span");h.className="sort-arrow";d.element.addClass(b?"sorted desc":"sorted");d.element[0].firstChild.insertBefore(h,d.element[0].firstChild.firstChild);d.n!=s.RELATIVE&&this.da&&(d.na=h.scrollWidth+(parseFloat(c(h).css("margin-right"))||0)+(parseFloat(c(h).css("margin-left"))||
...
G:function(){var a=((this.f||this.e).length-(this.c[0].childNodes.length-2))*this.D;if(0>a)this.N.style.height=0,this.ma.style.height=0;else{var b=this.a.first*this.D;this.N.style.height=b+"px";this.ma.style.height=a-b+"px"}},ca:function(a,b,d){var c=0;if(d)for(d=this.N.nextSibling;d&&1!=d.nodeType;)d=d.nextSibling;else d=this.ma;for(;a<b;a++)this.Va(a,d),c++;return c},Va:function(a,b){var d=document.createElement("tr");d._rowIndex=a;for(var c=(this.f||this.e)[a],f=!!this.f,e=this.ea,g=this.d,l=this.H,
p=0,k,m,n,q=g.length;p<q;p++)k=g[p],m=document.createElement("div"),m.style.width=(k.u||k.j)+"px",m.innerHTML=l(c[k.name],k.name),n=document.createElement("td"),k.cellClasses&&(n.className=k.cellClasses),e&&this.I(n),n.appendChild(m),d.appendChild(n);this.c[0].insertBefore(d,b);this.trigger("rowCreate",a,f?c.__i:a,d,c)},Ia:function(a,b){var d,c,f=0;a>this.t+2*this.r&&(a=this.t+2*this.r);var e=this.c[0],g=e.childNodes;c=this.c[0].childNodes.length-2;b?(d=1,c=Math.min(a+1,c+1)):(d=c+1-a,c+=1);for(var p=
d;p<c;c--)this.lb(g[d]),this.trigger("rowDestroy",g[d]),e.removeChild(g[d]),f++;return f},fb:function(a){for(var b=this.c[0].getElementsByTagName("tr"),d=this.f||this.e,e=!!this.f,f,g=this.d,p=this.H,l=1,u,k,m,n,q,s=b.length-1;l<s;l++){u=b[l];this.trigger("rowDestroy",u);u._rowIndex=f=a+l-1;f=d[f];k=c("td>div",u);for(m=0;m<k.length;m++)n=k[m],q=g[m],q=q.name,n.innerHTML=p(f[q],q);this.trigger("rowCreate",l,e?f.__i:l,u,f)}},Y:function(a){if(this.Z==w.Width.AUTO){a=this.g.find(">thead>tr>th");for(var b=
0,d=0;d<a.length;d++)b+=c(a[d])[0].offsetWidth;this.g.width(b);this.$el.width(b)}else if(this.Z==w.Width.SCROLL)if(a&&(a=this.el.style.display,this.el.style.display="none",this.el.offsetHeight,this.el.style.display=a),a=this.$el.innerWidth(),b=this.g.width(),d=this.p[0].scrollWidth,this.c.off("scroll",this.Fa),d>b||d>a)this.p.width(a),this.c.width(a),this.c.on("scroll",this.Fa);else{try{this.p[0].style.width=""}catch(e){}try{this.c[0].style.width=""}catch(f){}}return this},K:function(){return"rtl"===
this.g.css("direction")},V:function(a){return a.n===s.AUTO?"auto":a.n===s.RELATIVE?100*a.width+"%":a.width},Za:function(a){this.qa=!1;if(a.firstChild.scrollWidth>a.firstChild.clientWidth){this.ua();var b=c(a),d=c(a.firstChild),e=t("div"),f=c(e);e.innerHTML=a.innerHTML;e.className=this.q;if("TH"===a.tagName&&(e.className+=" header",b.hasClass("sortable")&&(e.className+=" sortable"),e.draggable=!0,e.k=a.k,c(e).on("mousemove",_.bind(this.Ca,this)).on("mouseleave",_.bind(this.Ba,this)).on("dragstart",
_.bind(this.Ea,this)).on("click",_.bind(this.wa,this)),c(e.firstChild).on("dragenter",_.bind(this.xa,this)).on("dragover",_.bind(this.za,this)).on("dragleave",_.bind(this.ya,this)).on("drop",_.bind(this.Aa,this)),p))c(e).on("selectstart",_.bind(function(a){a.preventDefault();this.nb();return!1},e));var g=parseFloat(b.css("padding-left"))||0,l=parseFloat(b.css("padding-right"))||0,u=parseFloat(b.css("padding-top"))||0,s=parseFloat(b.css("padding-bottom"))||0,k=a.firstChild.scrollWidth+a.clientWidth-
a.firstChild.offsetWidth,m=a.firstChild.scrollHeight+a.clientHeight-a.firstChild.offsetHeight;"border-box"===b.css("boxSizing")?(k-=parseFloat(c(a).css("border-left-width"))||0,k-=parseFloat(c(a).css("border-right-width"))||0,m-=parseFloat(c(a).css("border-top-width"))||0,m-=parseFloat(c(a).css("border-bottom-width"))||0,f.css("box-sizing","border-box")):(k-=g+l,m-=u+s,f.css({"margin-top":parseFloat(c(a).css("border-top-width"))||0}));if(!this.ka){var n=document.createElement("div");n.style.backgroundColor=
"transparent";this.ka=c(n).css("background-color");n.style.backgroundColor="rgba(0,0,0,0)";this.La=c(n).css("background-color")}n=c(a).css("background-color");if(n===this.ka||n===this.La)n=c(a.parentNode).css("background-color");if(n===this.ka||n===this.La)n="#fff";f.css({"box-sizing":"content-box",width:k+"px",height:m+"px","padding-left":g,"padding-right":l,"padding-top":u,"padding-bottom":s,overflow:"hidden",position:"absolute",zIndex:"-1",left:"0",top:"0","background-color":n,cursor:"default"});
document.body.appendChild(e);c(e.firstChild).css({width:e.clientWidth-a.clientWidth+parseFloat(a.firstChild.style.width)+"px",direction:d.css("direction"),"white-space":d.css("white-space"),height:m,display:"table-cell","vertical-align":c(a).css("vertical-align")});d=e.__row=a.parentNode._rowIndex;e.__column=this.d[_.indexOf(a.parentNode.childNodes,a)].name;this.trigger("cellPreview",e.firstChild,null==d?null:d,e.__column,null==d?null:(this.f||this.e)[d]);this.qa||(d=b.offset(),this.K()?(g=f.outerWidth(),
b=b.outerWidth(),d.left-=g-b):d.left+=parseFloat(c(a).css("border-left-width"))||0,d.top+=parseFloat(c(a).css("border-top-width"))||parseFloat(c(a).css("border-bottom-width"))||0,b=c(window).width()-f.outerWidth(),d.left=0>d.left?0:d.left>b?b:d.left,f.css({left:d.left,top:d.top,"z-index":9999}),e.__cell=a,this.Q=f,a.__previewEl=e,this.ha(a),this.ha(e))}},Ya:function(){this.ua()},ua:function(){if(this.Q){var a=this.Q[0];this.Q.remove().off("mousemove").off("mouseleave").off("dragstart").off("selectstart").off("click").find(">div").off("dragenter").off("dragover").off("dragleave").off("drop");
this.la(a.__cell);this.la(a);a.__cell.__previewEl=null;a.__cell=null;this.trigger("cellPreviewDestroy",a.firstChild,a.__row,a.__column);this.Q=null}return this}}),s={AUTO:0,ABSOLUTE:1,RELATIVE:2};w.Width={NONE:"none",AUTO:"auto",SCROLL:"SCROLL"};l.DGTable=w})(this,jQuery);
DGTable.Ta=function(){function l(){var c=[];_.extend(c,l.prototype);c.initialize.apply(c,arguments);return c}l.prototype=[];l.prototype.initialize=function(){};l.prototype.get=function(c){for(var e=0,g=this.length;e<g;e++)if(this[e].name==c)return this[e];return null};l.prototype.indexOf=function(c){for(var e=0,g=this.length;e<g;e++)if(this[e].name==c)return e;return-1};l.prototype.ba=function(c){for(var e=0,g=this.length;e<g;e++)if(this[e].order==c)return this[e];return null};l.prototype.pa=function(){var c=
...
DGTable.Ua=function(){function l(){var c=[];_.extend(c,l.prototype);c.initialize.apply(c,arguments);return c}l.prototype=[];_.extend(l.prototype,Backbone.Events);l.prototype.initialize=function(c){c=c||{};this.aa=this.O=null;this.oa=!1;this.sortColumn=null==c.sortColumn?[]:c.sortColumn};l.prototype.add=function(c,e){var g,l;if("splice"in c&&"length"in c)if(e)for(g=0,l=c.length;g<l;g++)this.splice(e++,0,c[g]);else for(g=0,l=c.length;g<l;g++)this.push(c[g]);else e?this.splice(e,0,c):this.push(c)};l.prototype.reset=
function(c){this.length=0;c&&this.add(c)};l.prototype.Pa=function(c,e,g){if((e=e.toString())&&null!=c){var u=new l({sortColumn:this.sortColumn});this.O=c;this.aa=e;this.oa=g;e=c=0;g=this.length;for(var p;e<g;e++)p=this[e],this.ob(p)&&(p.__i=c++,u.push(p));return u}return this.aa=this.O=null};l.prototype.ob=function(c){if(c&&this.O){c=c[this.O];if(null==c)return!1;c=c.toString();var e=this.aa;this.oa||(c=c.toUpperCase(),e=e.toUpperCase());return-1!==c.indexOf(e)}return!0};(function(){function c(c,
