'use strict';(function(l,e){function h(a){_.contains(["relative","absolute","fixed"],a.css("position"))||a.css("position","relative")}var g=navigator.userAgent,u=-1!=g.indexOf("MSIE ")?parseFloat(g.substr(g.indexOf("MSIE ")+5)):null,s=u&&10>u,v=_.bind(document.createElement,document),t=Backbone.View.extend({className:"dgtable-wrapper",tagName:"div",VERSION:"0.4.6",initialize:function(a){function b(a){a=a||event;a=a.toElement||a.relatedTarget;a==this||jQuery.contains(this,a)||this.__previewEl&&(a==
this.__previewEl||jQuery.contains(this.__previewEl,a))||n.Ga.call(n,this)}function c(a){a=a||event;a=a.fromElement||a.relatedTarget;a==this||jQuery.contains(this,a)||this.__previewEl&&(a==this.__previewEl||jQuery.contains(this.__previewEl,a))||n.Ha.call(n,this)}a=a||{};a.columns=a.columns||[];this.V=_.bind(this.La,this);this.L=_.bind(this.Ka,this);this.ua=_.bind(this.Ma,this);this.$el.on("dragend",this.L);this.s=!0;var d=this.a={};d.virtualTable=void 0===a.virtualTable?!0:!!a.virtualTable;d.rowsBufferSize=
...
d.cellPreviewAutoBackground=void 0===a.cellPreviewAutoBackground?!0:a.cellPreviewAutoBackground;d.comparatorCallback=void 0===a.comparatorCallback?null:a.comparatorCallback;d.width=void 0===a.width?t.Width.NONE:a.width;d.relativeWidthGrowsToFillWidth=void 0===a.relativeWidthGrowsToFillWidth?!0:!!a.relativeWidthGrowsToFillWidth;d.relativeWidthShrinksToFillWidth=void 0===a.relativeWidthShrinksToFillWidth?!1:!!a.relativeWidthShrinksToFillWidth;d.cellFormatter=a.cellFormatter||function(a){return a};d.headerCellFormatter=
a.headerCellFormatter||function(a){return a};d.height=a.height;var r,f,e,h,A=new t.Ea;for(h=r=0;r<a.columns.length;r++)f=a.columns[r],e=this.ja(f),void 0!==f.order?(f.order>h&&(h=f.order+1),e.order=f.order):e.order=h++,A.push(e);A.ca();this.d=A;this.b=A.H();this._ensureVisibleColumns();if(void 0===a.sortColumn)a.sortColumn=null;else if("string"==typeof a.sortColumn)this.d.get(a.sortColumn)?a.sortColumn=[{column:a.sortColumn,descending:!1}]:a.sortColumn=null;else if(a.sortColumn instanceof Array){h=
[];r=0;f=a.sortColumn.length;for(e;r<f&&(e=a.sortColumn[r],e=void 0!==e.column?e:{column:e,descending:!1},(e=this.d.get(e.column))&&!_.contains(h,e.name)&&h.push(e.name),h.length!==d.sortableColumns&&h.length!=this.b.length);r++);a.sortColumn=h}else"object"==typeof a.sortColumn?this.d.get(a.sortColumn.column)||(a.sortColumn=null):a.sortColumn=null;this.c=new t.Fa({sortColumn:a.sortColumn,columns:this.columns});this.listenTo(this.c,"requiresComparatorForColumn",_.bind(function(a,b,c){d.comparatorCallback&&
(a.Sa=d.comparatorCallback(b,c))},this));this.g=null;var n=this;"addEventListener"in window?(this.Q=function(a){a.__hoverIn||a.addEventListener("mouseover",a.__hoverIn=_.bind(c,a));return this},this.X=function(a){a.__hoverIn&&(a.removeEventListener("mouseover",a.__hoverIn),a.__hoverIn=null);return this},this.R=function(a){a.__hoverOut||a.addEventListener("mouseout",a.__hoverOut=_.bind(b,a.__cell||a));return this},this.Y=function(a){a.__hoverOut&&(a.removeEventListener("mouseout",a.__hoverOut),a.__hoverOut=
...
null;!a.da&&a.el.offsetParent&&a.render()})),a;if(!0===this.s){this.s=!1;b.width==t.Width.AUTO&&a.ha();var c=a.f?a.f.scrollTop:0,d=a.f?a.f.scrollLeft:0;a.tableWidthChanged(!0,!1).Oa();if(b.virtualTable)a.t();else{var e=(a.g||a.c).length,e=a.v(0,e-1);a.l.html("").append(e);a.t(!0)}a.f.scrollTop=c;a.f.scrollLeft=d;a.K.scrollLeft=d;this.u(!0);for(e=0;e<this.c.sortColumn.length;e++)this.xa(this.c.sortColumn[e].column,this.c.sortColumn[e].descending);b.adjustColumnWidthForSortArrow&&this.c.sortColumn.length?
this.tableWidthChanged(!0):b.virtualTable||this.tableWidthChanged();this.trigger("renderskeleton");b.virtualTable&&(this.h.on("scroll",_.bind(this.Na,this)),this.render())}else if(b.virtualTable){e=(a.g||a.c).length;d=this.f.scrollTop;c=Math.floor((d-this.B)/this.p)+1-b.rowsBufferSize;b=Math.ceil((d-this.B+this.Ra)/this.p)+b.rowsBufferSize;0>c&&(c=0);b>=e&&(b=e-1);var f=-1,d=-1,k=a.e.childNodes;k.length&&(f=k[0].rowIndex,d=k[k.length-1].rowIndex);if(-1!==f&&f<c){for(var h=Math.min(d+1,c)-f,e=0;e<
h;e++)a.trigger("rowdestroy",k[0]),a.m(k[0]),a.e.removeChild(k[0]);f+=h;f>d&&(f=d=-1)}else if(-1!==d&&d>b){h=d-Math.max(f-1,b);for(e=0;e<h;e++)a.trigger("rowdestroy",k[k.length-1]),a.m(k[k.length-1]),a.e.removeChild(k[k.length-1]);d<f&&(f=d=-1)}c<f&&(e=a.v(c,Math.min(b,f-1)),a.l.prepend(e));if(b>d||-1===d)e=a.v(-1===d?c:d+1,b),a.l.append(e)}this.trigger("render");return this},clearAndRender:function(){this.s=!0;return this.render()},v:function(a,b){var c=this.a,d=c.tableClassName,e=d+"-row",d=d+"-cell",
f=this.g||this.c,k=!!this.g,h=c.allowCellPreview,A=this.b,n=c.cellFormatter,c=c.virtualTable,p=this.B,m=this.p,g,l,u=A.length;g=0;for(var w;g<u;g++)w=A[g],w.Ia=w.q||w.j;for(var s=document.createDocumentFragment(),q=this.F()?"right":"left",t=a,E=f.length,B,y,z,D;t<E&&t<=b;t++){B=f[t];l=k?B.__i:t;y=v("div");y.className=e;y.rowIndex=t;y.physicalRowIndex=l;for(g=0;g<u;g++)w=A[g],z=v("div"),z.columnName=w.name,z.setAttribute("data-column",w.name),z.className=d,z.style.width=w.Ia+"px",w.cellClasses&&(z.className+=
" "+w.cellClasses),h&&this.Q(z),D=z.appendChild(v("div")),w=n(B[w.name],w.name,B),void 0===w&&(w=""),D.innerHTML=w,y.appendChild(z);c&&(g=0<t?p+(t-1)*m:0,y.style.position="absolute",y.style[q]=0,y.style.top=g+"px");s.appendChild(y);this.trigger("rowcreate",t,l,y,B)}return s},S:function(){if(this.e){var a=(this.g||this.c).length,b=this.p*a;a&&(b+=this.B-this.p,b+=this.Z-this.p);1>b&&(b=1);this.e.style.height=b+"px"}return this},fa:function(){var a=this.a.tableClassName,b=a+"-row",c=a+"-cell",d=this.b,
r=d.length,f,k,h,b=e("<div>").addClass(b).css("float","left");for(k=0;k<r;k++)h=d[k],f=v("div"),f.className=c,f.style.width=h.j+"px",h.cellClasses&&(f.className+=" "+h.cellClasses),f.appendChild(v("div")),b.append(f);a=e("<div>").addClass(this.className).css({"z-index":-1,position:"absolute",left:"0",top:"-9999px","float":"left",width:"1px",overflow:"hidden"}).append(e("<div>").addClass(a).append(e("<div>").addClass(a+"-body").css("width",99999).append(b)));a.appendTo(document.body);d=e('<div style="border:1px solid #000;width:0;height:0;position:absolute;left:0;top:-9999px">').appendTo(document.body);
...
c.tableClassName+"-header-cell");c=k<h?h+1:h;d[0].parentNode.insertBefore(d[k],d[c]);d=this.b[k];d=(d.q||d.j)+"px";f=this.b[h];f=(f.q||f.j)+"px";for(var g=this.l[0].childNodes,n=0,p=g.length,m;n<p;n++)m=g[n],1===m.nodeType&&(m.insertBefore(m.childNodes[k],m.childNodes[c]),m.childNodes[h].firstChild.style.width=f,m.childNodes[k].firstChild.style.width=d)}this.trigger("movecolumn",e.name,k,h)}return this},sort:function(a,b,c){var d=this.a,e=this.d.get(a);if(e){var f=this.c.sortColumn;f.length&&f[f.length-
...
D:function(a){return(parseFloat(e.css(a,"padding-left"))||0)+(parseFloat(e.css(a,"padding-right"))||0)},Ja:function(a){return(parseFloat(e.css(a,"border-left"))||0)+(parseFloat(e.css(a,"border-right"))||0)},ga:function(){var a=this.a,b,c,d;this.h&&(c=this.f?this.f.scrollTop:0,d=this.f?this.f.scrollLeft:0,a.virtualTable&&(b=this.h[0].style.display,this.h[0].style.display="none"));var r=this.$el.width();this.h&&(a.virtualTable&&(this.h[0].style.display=b),this.f.scrollTop=c,this.f.scrollLeft=d,this.K.scrollLeft=
d);var f;b=a.tableClassName;if(this.h)c=this.o;else{f=e("<div>").addClass(this.className).css({"z-index":-1,position:"absolute",left:"0",top:"-9999px"});a=e("<div>").addClass(b+"-header").appendTo(f);c=e("<div>").addClass(b+"-header-row").appendTo(a);for(a=0;a<this.b.length;a++)c.append(e("<div><div></div></div>").addClass(b+"-header-cell").addClass(this.b[a].cellClasses||""));f.appendTo(document.body)}r-=this.Ja(c[0]);b=c.find(">div."+b+"-header-cell");for(a=0;a<b.length;a++)e(b[a].firstChild),c=
e(b[a]),d="border-box"===c.css("boxSizing"),r-=(parseFloat(c.css("border-right-width"))||0)+(parseFloat(c.css("border-left-width"))||0)+(d?0:this.D(c[0]));f&&f.remove();return r},tableWidthChanged:function(){var a=null;return function(b,c){var d=this.a,r=this.ga(),f=r,k=0;c=void 0===c||c;var h=0;this.e||(c=!1);c&&(h=parseFloat(this.e.style.minWidth)||0);if(f!=a||b){a=r;var g,r=0,n=[],p,m,l=0;for(p=0;p<this.d.length;p++)this.d[p].q=null;for(p=0;p<this.b.length;p++)if(m=this.b[p],m.k===q.ABSOLUTE)g=
m.width,g+=m.aa||0,!m.ignoreMin&&g<d.minColumnWidth&&(g=d.minColumnWidth),f-=g,r+=g,g!==m.j&&(m.j=g,n.push(p));else if(m.k===q.AUTO){var u=m.label,s=this.a.tableClassName;g=void 0;u=e("<div>").addClass(this.$el).append(e("<div>").addClass(s+"-header").append(e("<div>").addClass(s+"-header-row").append(g=e("<div>").addClass(s+"-header-cell").append(e("<div>").text(u))))).css({position:"absolute",top:"-9999px",visibility:"hidden"});u.appendTo(document.body);g=g.width();u.remove();g+=20;g+=m.aa||0;!m.ignoreMin&&
g<d.minColumnWidth&&(g=d.minColumnWidth);f-=g;r+=g;g!==m.j&&(m.j=g,d.convertColumnWidthsToRelative||n.push(p))}else m.k===q.RELATIVE&&(l+=m.width,k++);if(d.convertColumnWidthsToRelative)for(p=0;p<this.b.length;p++)m=this.b[p],m.k===q.AUTO&&(m.k=q.RELATIVE,f+=m.j,m.width=m.j/r,l+=m.width,k++);if(k&&(1>l&&d.relativeWidthGrowsToFillWidth||1<l&&d.relativeWidthShrinksToFillWidth))for(p=0;p<this.b.length;p++)m=this.b[p],m.k===q.RELATIVE&&(m.width/=l);r=f;d=d.minColumnWidth/r;isNaN(d)&&(d=0);if(0<d){for(p=
l=0;p<this.b.length;p++)m=this.b[p],m.k===q.RELATIVE&&!m.ignoreMin&&m.width<d&&(l+=d-m.width,m.width=d);for(p=0;p<this.b.length;p++)m=this.b[p],m.k===q.RELATIVE&&!m.ignoreMin&&m.width>d&&0<l&&(g=Math.min(l,m.width-d),m.width-=g,l-=g)}for(p=0;p<this.b.length;p++)m=this.b[p],m.k===q.RELATIVE&&(g=Math.round(r*m.width),f-=g,k--,0===k&&1===f&&(g++,f--),-1===f&&(g--,f++),g!==m.j&&(m.j=g,n.push(p)));this.b[this.b.length-1].q=this.b[this.b.length-1].j-(this.A||0);if(c){f=this.fa();h<f&&this.u(!1);for(p=0;p<
n.length;p++)this.Pa(n[p]);h>f&&this.u(!1)}}return this}}(),tableHeightChanged:function(){var a=this.a;if(!this.h)return this;var b=this.$el.innerHeight()-(parseFloat(this.h.css("border-top-width"))||0)-(parseFloat(this.h.css("border-bottom-width"))||0);b!=a.height&&(a.height=b,this.e&&(this.e.style.height=Math.max(a.height-this.o.outerHeight(),1)+"px"),a.virtualTable&&this.clearAndRender());return this},addRows:function(a,b){if(a){this.c.add(a);if(this.a.virtualTable){for(;this.e.firstChild;)this.trigger("rowdestroy",
...
var d=e(a.currentTarget),g={x:c.pageX,y:c.pageY},f=g,k=function(){b.C=null;d.off("touchend").off("touchcancel");clearTimeout(l)},h=function(b){var c=e.Event(b),d=Array.prototype.slice.call(arguments,1);e.each("target clientX clientY offsetX offsetY screenX screenY pageX pageY which".split(" "),function(){c[this]=a[this];for(var b=0;b<d.length;b++)null!=d[b][this]&&(c[this]=d[b][this])});return c};d.trigger(h("mousedown",a.originalEvent.changedTouches[0],{which:1}));var l=setTimeout(function(){k();
d.one("touchend",function(a){a.preventDefault();d.off("touchend").off("touchcancel")}).one("touchcancel",function(){d.off("touchend").off("touchcancel")});9>Math.sqrt(Math.pow(Math.abs(f.x-g.x),2)+Math.pow(Math.abs(f.y-g.y),2))&&(b.cancelColumnResize(),d.trigger(h("mouseup",a.originalEvent.changedTouches[0],{which:3})))},500);d.on("touchend",function(a){var c=_.find(a.originalEvent.changedTouches,function(a){return a.identifier===b.C});c&&(k(),a.preventDefault(),f={x:c.pageX,y:c.pageY},9>Math.sqrt(Math.pow(Math.abs(f.x-
g.x),2)+Math.pow(Math.abs(f.y-g.y),2))||b.i)&&(d.trigger(h("mouseup",c,{which:1})),d.trigger(h("click",c,{which:1})))}).on("touchcancel",function(){k()}).on("touchmove",function(a){var c=_.find(a.originalEvent.changedTouches,function(a){return a.identifier===b.C});c&&(f={x:c.pageX,y:c.pageY},b.i&&(a.preventDefault(),d.trigger(h("mousemove",c))))})}},pa:function(a){if(1!==a.which)return this;var b=this.a,c=this.U(a);if(c){var d=this.d.get(c);if(!b.resizableColumns||!d||!d.resizable)return!1;c=this.F();
this.i&&e(this.i).remove();this.i=e("<div></div>").addClass(b.resizerClassName).css({position:"absolute",display:"block","z-index":-1,visibility:"hidden",width:"2px",background:"#000",opacity:0.7}).appendTo(this.$el);var b=d.element,g=this.i.parent(),d=b.offset(),f=g.offset();8===u&&(d=b.offset());f.left+=parseFloat(g.css("border-left-width"))||0;f.top+=parseFloat(g.css("border-top-width"))||0;d.left-=f.left;d.top-=f.top;d.top-=parseFloat(b.css("border-top-width"))||0;g=this.i.outerWidth();c?d.left-=
Math.ceil((parseFloat(b.css("border-left-width"))||0)/2):(d.left+=b.outerWidth(),d.left+=Math.ceil((parseFloat(b.css("border-right-width"))||0)/2));d.left-=Math.ceil(g/2);this.i.css({"z-index":"10",visibility:"visible",left:d.left,top:d.top,height:this.$el.height()})[0].columnName=b[0].columnName;try{this.i[0].style.zIndex=""}catch(k){}e(document).on("mousemove.dgtable",this.V);e(document).on("mouseup.dgtable",this.L);a.preventDefault()}},ra:function(a){var b=this.a;if(b.resizableColumns){var c=this.U(a);
...
(this.trigger("headerrowdestroy",this.r),this.o.find("div."+this.a.tableClassName+"-header-cell").remove(),this.r=this.o=null);return this},Oa:function(){function a(a){a.preventDefault()}this.ia();this.C=null;var b=this.a,c=b.allowCellPreview,d=b.allowHeaderCellPreview,g=b.tableClassName,f=g+"-header-cell",k=v("div"),l=e(k),u=v("div"),n=e(u);k.className=g+"-header";u.className=g+"-header-row";var p;s&&(p=function(a){a.preventDefault();this.Ta();return!1});for(var m=0,q,x,C,w;m<this.b.length;m++)if(q=
this.b[m],q.visible){x=v("div");w=e(x);x.draggable=!0;x.className=f;x.style.width=q.j+"px";b.sortableColumns&&q.sortable&&(x.className+=" sortable");x.columnName=q.name;x.setAttribute("data-column",q.name);C=v("div");C.innerHTML=b.headerCellFormatter(q.label,q.name);x.appendChild(C);c&&d&&this.Q(x);u.appendChild(x);this.b[m].element=w;w.on("mousedown.dgtable",_.bind(this.pa,this)).on("mousemove.dgtable",_.bind(this.ra,this)).on("mouseup.dgtable",_.bind(this.sa,this)).on("mouseleave.dgtable",_.bind(this.qa,
this)).on("touchstart.dgtable",_.bind(this.va,this)).on("dragstart.dgtable",_.bind(this.ta,this)).on("click.dgtable",_.bind(this.ka,this)).on("contextmenu.dgtable",a);e(C).on("dragenter.dgtable",_.bind(this.la,this)).on("dragover.dgtable",_.bind(this.na,this)).on("dragleave.dgtable",_.bind(this.ma,this)).on("drop.dgtable",_.bind(this.oa,this));if(s)w.on("selectstart.dgtable",_.bind(p,x));w.css({"-webkit-touch-callout":"none","-webkit-user-select":"none","-moz-user-select":"none","-ms-user-select":"none",
"-o-user-select":"none","user-select":"none"})}this.P&&this.P.remove();this.P=l;this.K=k;this.o=n;this.r=u;n.appendTo(this.P);l.prependTo(this.$el);this.trigger("headerrowcreate",u);this.el.style.overflow=b.width==t.Width.SCROLL?"hidden":"";if(this.h&&b.virtualTable){this.h.remove();if(this.l)for(c=this.l[0].childNodes,m=0,d=c.length;m<d;m++)this.trigger("rowdestroy",c[m]),this.m(c[m]);this.h=this.f=this.l=this.e=null}h(this.$el);!b.height&&b.virtualTable&&(b.height=this.$el.innerHeight());b.virtualTable&&
!this.p&&(k=function(){var a=v("div"),b=a.appendChild(v("div")),c=b.appendChild(v("div"));a.className=g+"-row";b.className=g+"-cell";c.innerHTML="0";a.style.visibility="hidden";a.style.position="absolute";return a},c=e("<div>").addClass(this.className).css({"z-index":-1,position:"absolute",left:"0",top:"-9999px",width:"1px",overflow:"hidden"}).append(e("<div>").addClass(g).append(m=e("<div>").addClass(g+"-body").css("width",99999))),c.appendTo(document.body),d=k(),f=k(),k=k(),m.append(d,f,k),this.B=
e(d).outerHeight(),this.p=e(f).outerHeight(),this.Z=e(k).outerHeight(),Math.min(Math.min(this.B,this.p),this.Z),Math.max(Math.max(this.B,this.p),this.Z),c.remove());this.h||(m=document.createDocumentFragment(),c=v("div"),d=e(c),c.className=b.tableClassName,b.virtualTable&&(c.className+=" virtual"),n=b.height-n.outerHeight(),"border-box"!==d.css("box-sizing")&&(n-=parseFloat(d.css("border-top-width"))||0,n-=parseFloat(d.css("border-bottom-width"))||0,n-=parseFloat(d.css("padding-top"))||0,n-=parseFloat(d.css("padding-bottom"))||
0),this.Ra=n,c.style.height=b.height?n+"px":"auto",c.style.display="block",c.style.overflowY="auto",c.style.overflowX=b.width==t.Width.SCROLL?"auto":"hidden",m.appendChild(c),n=v("div"),f=e(n),n.className=b.tableClassName+"-body",this.f=c,this.e=n,this.h=d,this.l=f,this.S(),h(f),h(d),c.appendChild(n),this.el.appendChild(m));return this},t:function(a){var b=this.f.offsetWidth-this.f.clientWidth;if(b!=this.A||a){this.A=b;for(a=0;a<this.d.length;a++)this.d[a].q=null;if(0<this.A){b=this.b.length-1;this.b[b].q=
this.b[b].j-this.A;var c=this.b[b].q+"px",d=this.e.childNodes;a=0;for(var e=d.length,f;a<e;a++)f=d[a],1===f.nodeType&&(f.childNodes[b].style.width=c);this.r.childNodes[b].style.width=c}}return this},u:function(a){var b=this.a,c=this.fa();this.e.style.minWidth=c+"px";this.r.style.minWidth=c+(this.A||0)+"px";this.h.off("scroll",this.ua);if(b.width==t.Width.AUTO)this.$el.width(this.h.width(this.l.outerWidth()).outerWidth());else if(b.width==t.Width.SCROLL){if(a){a=this.f?this.f.scrollTop:0;var b=this.f?
...
e(d),k=v("div"),h=e(k);k.innerHTML=a.innerHTML;k.className=c.cellPreviewClassName;if(c=g.hasClass(c.tableClassName+"-header-cell"))if(k.className+=" header",g.hasClass("sortable")&&(k.className+=" sortable"),k.draggable=!0,e(k).on("mousedown",_.bind(b.pa,b)).on("mousemove",_.bind(b.ra,b)).on("mouseup",_.bind(b.sa,b)).on("mouseleave",_.bind(b.qa,b)).on("touchstart",_.bind(b.va,b)).on("dragstart",_.bind(b.ta,b)).on("click",_.bind(b.ka,b)).on("contextmenu.dgtable",function(a){a.preventDefault()}),e(k.firstChild).on("dragenter",
_.bind(b.la,b)).on("dragover",_.bind(b.na,b)).on("dragleave",_.bind(b.ma,b)).on("drop",_.bind(b.oa,b)),s)e(k).on("selectstart",_.bind(function(a){a.preventDefault();this.Ta();return!1},k));var l=parseFloat(g.css("padding-left"))||0,n=parseFloat(g.css("padding-right"))||0,u=parseFloat(g.css("padding-top"))||0,m=parseFloat(g.css("padding-bottom"))||0,d=d.scrollWidth+a.clientWidth-d.offsetWidth;"border-box"===g.css("boxSizing")?(d-=parseFloat(e(a).css("border-left-width"))||0,d-=parseFloat(e(a).css("border-right-width"))||
0,h.css("box-sizing","border-box")):(d-=l+n,h.css({"margin-top":parseFloat(e(a).css("border-top-width"))||0}));if(!b.W){var q=document.createElement("div");q.style.backgroundColor="transparent";b.W=e(q).css("background-color");q.style.backgroundColor="rgba(0,0,0,0)";b.ya=e(q).css("background-color")}l={"box-sizing":"content-box",width:d+"px","min-height":g.height()+"px","padding-left":l,"padding-right":n,"padding-top":u,"padding-bottom":m,overflow:"hidden",position:"absolute",zIndex:"-1",left:"0",
top:"0",cursor:"default"};n=e(a).css("background-color");if(n===b.W||n===b.ya)n=e(a.parentNode).css("background-color");if(n===b.W||n===b.ya)n="#fff";l["background-color"]=n;h.css(l);document.body.appendChild(k);e(k.firstChild).css({direction:f.css("direction"),"white-space":f.css("white-space")});c&&h.css({"-webkit-touch-callout":"none","-webkit-user-select":"none","-moz-user-select":"none","-ms-user-select":"none","-o-user-select":"none","user-select":"none"});k.rowIndex=a.parentNode.rowIndex;f=
k.physicalRowIndex=a.parentNode.physicalRowIndex;k.columnName=b.b[_.indexOf(a.parentNode.childNodes,a)].name;b.trigger("cellpreview",k.firstChild,null==f?null:f,k.columnName,null==f?null:b.c[f]);this.ea?h.remove():(f=g.offset(),"right"===g.css("float")?(c=h.outerWidth(),l=g.outerWidth(),f.left-=c-l,f.left-=parseFloat(e(a).css("border-right-width"))||0):f.left+=parseFloat(e(a).css("border-left-width"))||0,f.top+=parseFloat(e(a).css("border-top-width"))||parseFloat(e(a).css("border-bottom-width"))||
0,c=e(window).width()-h.outerWidth(),f.left=0>f.left?0:f.left>c?c:f.left,g=g.outerHeight(),g=e(document).scrollTop()+e(window).innerHeight()-g,f.top>g&&(f.top=Math.max(0,g)),h.css({left:f.left,top:f.top,"z-index":9999}),k.__cell=a,b.I=h,a.__previewEl=k,b.R(a),b.R(k),h.on("mousewheel",function(a){var c=a.originalEvent,d=c.wheelDelta||-c.detail;a=c.wheelDeltaX||(1==c.axis?d:0);c=c.wheelDeltaY||(2==c.axis?d:0);d&&b.hideCellPreview();c&&b.f.scrollHeight>b.f.clientHeight&&(d=-1*c+b.h.scrollTop(),b.h.scrollTop(d));
a&&b.f.scrollWidth>b.f.clientWidth&&(a=-1*a+b.h.scrollLeft(),b.h.scrollLeft(a))}))}},Ga:function(){this.hideCellPreview()},hideCellPreview:function(){if(this.I){var a=this.I[0];this.I.remove();this.Y(a.__cell);this.Y(a);a.__cell.__previewEl=null;a.__cell=null;this.trigger("cellpreviewdestroy",a.firstChild,a.physicalRowIndex,a.columnName);this.I=null}this.ea=!1;return this}}),q={AUTO:0,ABSOLUTE:1,RELATIVE:2};t.Width={NONE:"none",AUTO:"auto",SCROLL:"SCROLL"};l.DGTable=t})(this,jQuery);
DGTable.Ea=function(){function l(){var e=[];_.extend(e,l.prototype);e.initialize.apply(e,arguments);return e}l.prototype=[];l.prototype.initialize=function(){};l.prototype.get=function(e){for(var h=0,g=this.length;h<g;h++)if(this[h].name==e)return this[h];return null};l.prototype.indexOf=function(e){for(var h=0,g=this.length;h<g;h++)if(this[h].name==e)return h;return-1};l.prototype.O=function(e){for(var h=0,g=this.length;h<g;h++)if(this[h].order==e)return this[h];return null};l.prototype.ca=function(){var e=
[],h;for(h=0;h<this.length;h++)e.push(this[h]);e.sort(function(e,h){return e.order<h.order?-1:e.order>h.order?1:0});for(h=0;h<e.length;h++)e[h].order=h};l.prototype.H=function(){for(var e=[],h=0,g;h<this.length;h++)g=this[h],g.visible&&e.push(g);e.sort(function(e,g){return e.order<g.order?-1:e.order>g.order?1:0});return e};l.prototype.Ba=function(){for(var e=0,h=0,g;h<this.length;h++)g=this[h],g.order>e&&(e=g.order);return e};l.prototype.moveColumn=function(e,h){if(e&&h){var g=e.order,l=h.order,s;
if(g<l)for(g+=1;g<=l;g++)s=this.O(g),s.order--;else for(g-=1;g>=l;g--)s=this.O(g),s.order++;e.order=l}return this};return l}();
DGTable.Fa=function(){function l(){var e=[];_.extend(e,l.prototype);e.initialize.apply(e,arguments);return e}l.prototype=[];_.extend(l.prototype,Backbone.Events);l.prototype.initialize=function(e){e=e||{};this.N=this.G=null;this.ba=!1;this.sortColumn=null==e.sortColumn?[]:e.sortColumn};l.prototype.add=function(e,h){var g,l;if("splice"in e&&"length"in e)if(h)for(g=0,l=e.length;g<l;g++)this.splice(h++,0,e[g]);else for(g=0,l=e.length;g<l;g++)this.push(e[g]);else h?this.splice(h,0,e):this.push(e)};l.prototype.reset=
function(e){this.length=0;e&&this.add(e)};l.prototype.Aa=function(e,h,g){if((h=h.toString())&&null!=e){var u=new l({sortColumn:this.sortColumn});this.G=e;this.N=h;this.ba=g;e=0;for(h=this.length;e<h;e++)g=this[e],this.Ua(g)&&(g.__i=e,u.push(g));return u}return this.N=this.G=null};l.prototype.Ua=function(e){if(e&&this.G){e=e[this.G];if(null==e)return!1;e=e.toString();var h=this.N;this.ba||(e=e.toUpperCase(),h=h.toUpperCase());return-1!==e.indexOf(h)}return!0};(function(){function e(e,h){var l=h?1:
-1,v=h?-1:1;return function(h,q){var a=h[e],b=q[e];return a<b?l:a>b?v:0}}var h=l.prototype.sort;l.prototype.sort=function(g){if(this.sortColumn.length){var l=[],s,v;for(s=0;s<this.sortColumn.length;s++)v={},this.trigger("requiresComparatorForColumn",v,this.sortColumn[s].column,this.sortColumn[s].descending),l.push(_.bind(v.Sa||e(this.sortColumn[s].column,this.sortColumn[s].descending),this));if(1===l.length)h.call(this,l[0]);else{var t=l.length,q;h.call(this,function(a,b){for(s=0;s<t&&(q=l[s](a,b),
0===q);s++);return q})}g||this.trigger("sort")}return this}})();return l}();
