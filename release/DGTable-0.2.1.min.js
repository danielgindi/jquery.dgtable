'use strict';(function(h,e){var g=navigator.userAgent,k=-1!=g.indexOf("MSIE ")?parseFloat(g.substr(g.indexOf("MSIE ")+5)):null,m=k&&10>k,p=k&&10>k,q=Backbone.View.extend({className:"dgtable-wrapper",tagName:"div",VERSION:"0.2.0",initialize:function(a){a=a||{};a.columns=a.columns||[];this.Y=_.bind(this.Ja,this);this.L=_.bind(this.Ga,this);this.$el.on("dragend",this.L);this.n=!0;this.J=!1;this.j=void 0===a.virtualTable?!0:!!a.virtualTable;this.s=a.rowsBufferSize||10;this.k=Math.max(a.minColumnWidth||
...
hideColumn:function(a){var b=this.a.get(a);b&&b.visible&&(b.visible=!1,this.n=!0,this.b=this.a.B(),this.render(),this.trigger("hideColumn",a));return this},setMinColumnWidth:function(a){a=Math.max(a,0);this.k!=a&&(this.k=a,this.fa(!0));return this},getMinColumnWidth:function(){return this.k},setSortableColumns:function(a){if(this.q!=a&&(this.q=a,this.g)){a=this.g.find("thead>tr>th");for(var b=0;b<a.length;b++)e(a[0])[0<this.q&&this.b[b].sortable?"addClass":"removeClass"]("sortable")}return this},
...
d="rtl"==this.g.css("direction"),b=b.element,f=this.i.parent(),c=b.offset(),e=f.offset();e.left+=parseFloat(f.css("border-left-width"))||0;c.left-=e.left;f=this.i.outerWidth();a=a.pageX-e.left;c=c.left;d?(c+=b.outerWidth(),c-=Math.ceil((parseFloat(b.css("border-right-width"))||0)/2),c-=Math.ceil(f/2),c-=this.k,c-=this.G(b[0]),a>c&&(a=c)):(c+=Math.ceil((parseFloat(b.css("border-right-width"))||0)/2),c-=Math.ceil(f/2),c+=this.k,c+=this.G(b[0]),a<c&&(a=c));this.i.css("left",a+"px")},Ga:function(a){if(this.i){e(document).off("mousemove",
this.Y);e(document).off("mouseup",this.L);var b=this.a.get(this.i[0].m),d="rtl"==this.g.css("direction"),f=b.element,c=this.i.parent(),l=f.offset(),g=c.offset();g.left+=parseFloat(c.css("border-left-width"))||0;l.left-=g.left;c=this.i.outerWidth();a=a.pageX-g.left;l=g=l.left;l=0;d?(a+=this.G(f[0]),g+=f.outerWidth(),g-=Math.ceil((parseFloat(f.css("border-right-width"))||0)/2),g-=Math.ceil(c/2),l=g-this.k,a>l&&(a=l),l=g-a):(a-=this.G(f[0]),g+=Math.ceil((parseFloat(f.css("border-right-width"))||0)/2),
g-=Math.ceil(c/2),l=g+this.k,a<l&&(a=l),l=a-g);this.i.remove();this.i=null;d=l;if(b.o==n.RELATIVE){d=this.ha();for(f=0;f<this.b.length;f++)c=this.b[f],c.o!=n.RELATIVE&&(d-=c.l);d=l/d*100;d+="%"}this.setColumnWidth(b.name,d)}else a.target.style.opacity=null},Ca:function(a){if(this.u){var b=a.originalEvent.dataTransfer.getData("text"),b=b?JSON.parse(b):null;a=e(a.target).closest("th");(!b||this.W==b.ra&&a.m!==b.column)&&(b=this.a.get(a[0].m))&&(b.C||b!=this.b[0])&&e(a).addClass("drag-over")}},Ea:function(a){a.preventDefault()},
...
_.forEach(b,_.bind(function(a){var b=this.a.get(a.parentNode.parentNode.m);if(b){if(b.o!=n.RELATIVE){var c=a.scrollWidth+(parseFloat(e(a).css("margin-right"))||0)+(parseFloat(e(a).css("margin-left"))||0);b.l=Math.max(b.l-c,this.k);this.Z(a.parentNode.parentNode.cellIndex)}a.parentNode.removeChild(a)}},this));a.removeClass("sorted").removeClass("desc")}return this},pa:function(a,b){var d=this.a.get(a),f=document.createElement("span");f.className="sort-arrow";d.element.addClass(b?"sorted desc":"sorted");
d.element[0].firstChild.insertBefore(f,d.element[0].firstChild.firstChild);d.o!=n.RELATIVE&&(f=f.scrollWidth+(parseFloat(e(f).css("margin-right"))||0)+(parseFloat(e(f).css("margin-left"))||0),d.l=Math.max(d.l+f,this.k),this.Z(d.element[0].cellIndex));return this},Z:function(a){var b=this.g.find(">thead>tr>th"),d=this.a.get(b[a].m);if(d){d=d.l;b[a].firstChild.style.width=d+"px";a===b.length-1&&(d-=this.v);for(var d=d+"px",b=this.e[0].childNodes,f=this.j?1:0,c=b.length-(this.j?1:0),e;f<c;f++)e=b[f],
...
return h}();
//# sourceMappingURL=DGTable-0.2.1.min.js.map